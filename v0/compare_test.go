...
func TestCompare(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			Differences{
				Difference{Type: CHANGE, Path: []string{}, From: testTimeA, To: testTimeB},
			},
			nil,
		},
		{
		...
		//	Differences{
		//		Difference{Type: ADD, Path: []string{"identifiables", "two", "name"}, From: nil, To: "two"},
		//		Difference{Type: ADD, Path: []string{"identifiables", "two", "value"}, From: nil, To: 2},
		//	},
		//	nil,
		//},
		{
		...
		//	Differences{
		//		Difference{Type: REMOVE, Path: []string{"identifiables", "two", "name"}, From: "two", To: nil},
		//		Difference{Type: REMOVE, Path: []string{"identifiables", "two", "value"}, From: 2, To: nil},
		//	},
		//	nil,
		//},
		//{
		...
		//	Differences{
		//		Difference{Type: CHANGE, Path: []string{"unidentifiables", "0", "value"}, From: 1, To: 5},
		//		Difference{Type: ADD, Path: []string{"unidentifiables", "3", "value"}, From: nil, To: 4},
		//	},
		//	nil,
		//},
		//{
		...
		//	Differences{
		//		Difference{Type: CHANGE, Path: []string{"Public"}, From: "one", To: "two"},
		//	},
		//	nil,
		//},
		//{
		...
		//	Differences{
		//		Difference{Type: ADD, Path: []string{"nested", "slice", "0", "foo"}, From: nil, To: "one"},
		//		Difference{Type: ADD, Path: []string{"nested", "slice", "0", "bar"}, From: nil, To: 1},
		//		Difference{Type: ADD, Path: []string{"nested", "slice", "1", "foo"}, From: nil, To: "two"},
		//		Difference{Type: ADD, Path: []string{"nested", "slice", "1", "bar"}, From: nil, To: 2},
		//	},
		//	nil,
		//},
		{
		...
		},
		{
			...
			Differences{
				...
				Difference{Type: ADD, Path: []string{"1", "type"}, From: nil, To: []string{"null", "string"}},
			},
			nil,
		},
		//{
		...
		//	Differences{
		//		Difference{Type: ADD, Path: []string{"two", "foo"}, From: nil, To: "two"},
		//		Difference{Type: ADD, Path: []string{"two", "bar"}, From: nil, To: 2},
		//	},
		//	nil,
		//},
		//{
		...
		//	map[string]*tmstruct{"one": &struct1},
		//	Differences{
		//		Difference{Type: REMOVE, Path: []string{"two", "foo"}, From: "two", To: nil},
		//		Difference{Type: REMOVE, Path: []string{"two", "bar"}, From: 2, To: nil},
		//	},
		//	nil,
		//},
		{
			...
			Differences{
				Difference{Type: CHANGE, Path: []string{"private"}, From: int64(1), To: int64(4)},
			},
			nil,
		},
		{
			...
			Differences{
				Difference{Type: CHANGE, Path: []string{"Name"}, From: "a", To: "b"},
				Difference{Type: CHANGE, Path: []string{"Value"}, From: 2, To: 3},
				Difference{Type: CHANGE, Path: []string{"baz"}, From: true, To: false},
			},
			nil,
		},
		{
			...
			EmbeddedStruct{SimpleStructNoTag{Name: "b", Value: 3}, false},
			Differences{
				Difference{Type: CHANGE, Path: []string{"SimpleStructNoTag", "Name"}, From: "a", To: "b"},
				Difference{Type: CHANGE, Path: []string{"SimpleStructNoTag", "Value"}, From: 2, To: 3},
				Difference{Type: CHANGE, Path: []string{"baz"}, From: true, To: false},
			},
			nil,
		},
		{
			...
			Differences{
				Difference{Type: CHANGE, Path: []string{"name"}, From: "TestA", To: "TestB"},
				Difference{Type: REMOVE, Path: []string{"addons", "20", "name"}, From: "Sub2"},
